...
namespace Microsoft.Kusto.ServiceLayer.UnitTests.Connection
{
    ...
    public class ConnectionServiceTests
    {
        ...
        public async Task ConnectingWhenConnectionExistCausesDisconnectThenConnect()
        {
            ...
            var dummyConnection = new TestReliableDataSourceConnection(null, null);

            var mockFactory = new Mock<IDataSourceConnectionFactory>();
            mockFactory.Setup(factory => factory.CreateDataSourceConnection(It.IsAny<string>(), It.IsAny<string>()))
            .Returns((string connString, string azureAccountToken) =>
            {
                dummyConnection.ConnectionString = connString;
                ...
                dummyConnection.ChangeDatabase(dbName);
        ...
        [InlineData("ApplicationIntent", "NotAValidApplicationIntent")]
        ...
        public static readonly object[][] ConnectionStringWithInvalidOptionCombinations =
        {
            new object[]
            {
                ...
                new []
                {
                    Tuple.Create<string, object>("AuthenticationType", null),
            ...
            new object[]
            {
                ...
                new []
                {
                    Tuple.Create<string, object>("AuthenticationType", "Disabled"),
                    Tuple.Create<string, object>("EnclaveAttestationProtocol", "AAS"),
                    Tuple.Create<string, object>("EnclaveAttestationUrl", "https://attestation.us.attest.azure.net/attest/SgxEnclave")
                }
            },
            new object[]
            {
                ...
                new []
                {
                    Tuple.Create<string, object>("AuthenticationType", ""),
                    Tuple.Create<string, object>("EnclaveAttestationProtocol", "AAS"),
                    Tuple.Create<string, object>("EnclaveAttestationUrl", "https://attestation.us.attest.azure.net/attest/SgxEnclave")
                }
            }
        ...
        public async void DbConnectionDoesntLeakUponDisconnect()
        {
            ...
            var mockDefaultConnection = new Mock<ReliableDataSourceConnection> { CallBase = true };
            ...
            var mockQueryConnection = new Mock<ReliableDataSourceConnection> { CallBase = true };
        ...
        public async Task ConnectionWithAdminConnectionEnsuresOnlyOneConnectionCreated()
        {
            ...
            ReliableDataSourceConnection defaultConn = await service.GetOrOpenConnection(connectionParameters.OwnerUri, ConnectionType.Default);
            ...
            ReliableDataSourceConnection queryConn = await service.GetOrOpenConnection(connectionParameters.OwnerUri, ConnectionType.Query);
        ...
        public async Task CanChangeDatabase()
        {
            ...
            const string otherDbName = "other";
            // Given a connection that returns the database name
            var connection = new TestReliableDataSourceConnection(null, null);
        ...
        public async void ConnectingWithAzureAccountUsesToken()
        {
            ...
            mockFactory.Verify(factory => factory.CreateDataSourceConnection(It.IsAny<string>(), It.Is<string>(accountToken => accountToken == azureAccountToken)), Times.Once());
        }
    }
}
