...
namespace Microsoft.SqlTools.ServiceLayer.UnitTests.QueryExecution
{
    public class ChangeUriTests
    {
        ...
        public async Task ChangeUriForExecutedQuery()
        {
            ...
            var changeUriParams = new QueryChangeUriParams {
                OriginalOwnerUri = Constants.OwnerUri,
                NewOwnerUri = newOwnerUri
            };
        
            
            await queryService.HandleChangeUriNotification(changeUriParams, new TestEventContext());
        ...
        public void ChangeUriForMissingQuery()
        {
            ...
            Assert.ThrowsAsync<Exception>(async () => await queryService.HandleChangeUriNotification(changeUriParams, new TestEventContext()));
