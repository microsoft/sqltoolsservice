...
namespace Microsoft.SqlTools.ServiceLayer.UnitTests.QueryExecution
{
    ...
    public class AcceptedQueryCompletionTests
    {
        ...
        /// <summary>
        /// Cancelling while the pre-execution step is stalled completes the accepted query.
        /// </summary>
        [Test]
        [Timeout(10_000)]
        ...
        /// <summary>
        /// A pre-execution failure after the user cancelled is reported as a cancellation, not an error.
        /// </summary>
        [Test]
        [Timeout(10_000)]
        public async Task CancelledQueryReportsCancellationWhenPreExecutionStepThrows()
        {
            ...
            connectionService
                ...
                .Returns(() =>
                {
                    // The driver surfaces the user's cancellation as an ordinary exception.
