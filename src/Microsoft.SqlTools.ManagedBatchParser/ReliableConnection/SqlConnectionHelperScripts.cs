...
";
        ...
        public const string GetHostSysInfoBeforeVersion11 = @"SELECT cpu_count, physical_memory_in_bytes from sys.dm_os_sys_info";
        public const string GetHostSysInfoSinceVersion11 = @"SELECT cpu_count, physical_memory_kb from sys.dm_os_sys_info"; 
    }
}
