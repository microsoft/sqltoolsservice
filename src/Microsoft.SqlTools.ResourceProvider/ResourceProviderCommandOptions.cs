...
{
    class ResourceProviderCommandOptions : CommandOptions
    {
        internal const string ServiceName = "SqlToolsResourceProviderService.exe";

        public ResourceProviderCommandOptions(string[] args) : base(args, ServiceName)
        {
        }
