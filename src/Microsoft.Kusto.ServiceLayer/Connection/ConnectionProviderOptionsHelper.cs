...
namespace Microsoft.Kusto.ServiceLayer.Connection
{
    ...
    internal class ConnectionProviderOptionsHelper
    {
        ...
        {
            var connectionProviderOptions = new List<ConnectionOption>
            {
            ...
            if (Program.ServiceName == DataSourceType.Kusto)
            {
                connectionProviderOptions.Add(new ConnectionOption
                {
                    Name = "database",
            ...
            {
                Options = connectionProviderOptions.ToArray()
            };
        }
    }
}