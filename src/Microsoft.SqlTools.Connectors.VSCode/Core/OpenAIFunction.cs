...
/// </summary>
public sealed class VSCodeFunctionParameter
{
    internal VSCodeFunctionParameter(string? name, string? description, bool isRequired, Type? parameterType, KernelJsonSchema? schema)
    {
...
public sealed class OpenAIFunction
{
    ...
    internal OpenAIFunction(
        ...
        string functionName,
        string? description,
        IReadOnlyList<VSCodeFunctionParameter>? parameters,
    ...
    public IReadOnlyList<VSCodeFunctionParameter>? Parameters { get; }
    ...
    public ChatTool ToFunctionDefinition()
    {
        ...
        IReadOnlyList<VSCodeFunctionParameter>? parameters = this.Parameters;
