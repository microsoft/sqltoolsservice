...
public class VSCodePromptExecutionSettings : PromptExecutionSettings
{
    /// <summary>
    ...
    {
        return this.Clone<VSCodePromptExecutionSettings>();
    }
    ...
    public static VSCodePromptExecutionSettings FromExecutionSettings(PromptExecutionSettings? executionSettings, int? defaultMaxTokens = null)
    {
        ...
        if (executionSettings is VSCodePromptExecutionSettings settings)
        {
            return settings;
        }
        ...
        var openAIExecutionSettings = JsonSerializer.Deserialize<VSCodePromptExecutionSettings>(json, JsonOptionsCache.ReadPermissive);
    ...
    protected internal T Clone<T>() where T : VSCodePromptExecutionSettings, new()
    {
        return new T()
        {
