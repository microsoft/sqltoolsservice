...
namespace Microsoft.SqlTools.ServiceLayer.Credentials.OSX
{
    internal partial class Interop
    {
        internal partial class Security
        {
             ...
             * @param passwordData On return, a pointer to a data buffer containing the password. Your application must call SecKeychainItemFreeContent(NULL, passwordData) 
             ...
             * @discussion The SecKeychainFindGenericPassword function finds the first generic password item which matches the attributes you provide. 
             ...
             * @result A result code. See "Security Error Codes" (SecBase.h).
             * @discussion If itemRef has not previously been added to the keychain, SecKeychainItemDelete does nothing and returns ErrSecSuccess. 
