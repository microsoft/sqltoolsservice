...
namespace Microsoft.SqlTools.ServiceLayer.DacFx
{
    ...
    class ExtractOperation : DacFxOperation
    {
        ...
        public override void Execute()
        {
            ...
            this.DacServices.Extract(this.Parameters.PackageFilePath, this.Parameters.DatabaseName, this.Parameters.ApplicationName, version, applicationDescription:null, tables:null, extractOptions:extractOptions, cancellationToken:this.CancellationToken, this.Parameters.DiagnosticsLogFilePath);
        }
