...
namespace Microsoft.SqlTools.ServiceLayer.QueryExecution.DataStorage
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of <see cref="SaveAsXmlFileStreamFactory"/>.
        /// </summary>
        ...
        public SaveAsXmlFileStreamFactory(
            QueryExecutionSettings queryExecutionSettings,
            SaveResultsAsXmlRequestParams saveRequestParams,
        ...
        {
            return new SaveAsXmlFileStreamWriter(GetOutputStream(fileName), SaveRequestParams, columns);
        }
    }
}
