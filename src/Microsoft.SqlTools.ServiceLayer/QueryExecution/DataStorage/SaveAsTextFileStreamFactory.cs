...
namespace Microsoft.SqlTools.ServiceLayer.QueryExecution.DataStorage
{
    ...
    /// </summary>
    public class SaveAsTextFileStreamFactory : IFileStreamFactory
    {
        #region Properties
        ...
        /// <summary>
        /// Parameters for the save as text request
        /// </summary>
        public SaveResultsAsTextRequestParams SaveRequestParams { get; set; }
        ...
        {
            return new SaveAsTextFileStreamWriter(new FileStream(fileName, FileMode.Create, FileAccess.ReadWrite, FileShare.ReadWrite), SaveRequestParams);
        }
