...
namespace Microsoft.SqlTools.ServiceLayer.QueryExecution
{
    ...
    public sealed class QueryExecutionService : IDisposable
    {
            ...
            bool applyExecutionSettings = false)
        {
            ...
            {
                // SqlClient reports a cancelled command as a SqlException, so go by the query state.
        ...
        /// <summary>
        /// Completes a query that was cancelled after it was accepted but before execution started.
        /// </summary>
