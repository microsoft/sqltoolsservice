...
{    
    ...
    public class DisposeDatabaseRoleViewRequest
    {
        ...
        /// </summary>
        public static readonly
            RequestType<DisposeDatabaseRoleViewRequestParams, object> Type =
            RequestType<DisposeDatabaseRoleViewRequestParams, object>.Create("objectManagement/disposeDatabaseRoleView");
    }
