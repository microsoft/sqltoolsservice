//------------------------------------------------------------------------------
// <copyright file="ServiceManager.cs" company="Microsoft">
...
namespace Microsoft.Data.Tools.Design.Core.Context
{
    ...
    public abstract class ServiceCollection : IServiceProvider, IEnumerable<Type> {
        ...
        /// Returns true if the service collection contains a service of the given type.
        /// </summary>
        /// <typeparam name="ServiceType">The type of service to check.</typeparam>
        /// <returns>True if a service of type ServiceType has been published.</returns>
        ...
        public TServiceType GetRequiredService<TServiceType>() {
            ...
            if (service == null) {
                throw new NotSupportedException("Error in Required Service, Service is null");
                /*
                throw new NotSupportedException(
                    string.Format(CultureInfo.CurrentCulture,
                    Resources.Error_RequiredService, typeof(ServiceType).FullName));
                */
            }
            return service;
        }
        ...
        private class PublishProxy<ServiceType> {
            private PublishServiceCallback<ServiceType> _genericCallback;
