//------------------------------------------------------------------------------
// <copyright file="EditingContext.cs" company="Microsoft">
    ...
    public class EditingContext : IDisposable {
        ...
        public ContextItemCollection Items {
            get {
                if (_contextItems == null) {
                    ...
                    if (_contextItems == null) {
                        throw new InvalidOperationException("CreateContextItemCollection");
                        /*
                        throw new InvalidOperationException(
                            string.Format(CultureInfo.CurrentCulture, Resources.Error_NullImplementation, "CreateContextItemCollection"));
                        */
                    }
                }
        ...
        public ServiceCollection Services {
            get {
                if (_services == null) {
                    ...
                    if (_services == null) {
                        throw new InvalidOperationException("CreateServiceCollection");
                        /*
                        throw new InvalidOperationException(
                            string.Format(CultureInfo.CurrentCulture, Resources.Error_NullImplementation, "CreateServiceCollection"));
                        */
                    }
                }
        ...
        private sealed class DefaultContextItemCollection : ContextItemCollection, IDisposable {
            ...
            public override void SetValue(ContextItem value) {
                ...
                existing = GetValueNull(value.ItemType);

                if (existing != null && !existing.CanBeReplaced)
                {
                    throw new InvalidOperationException();
                }
            ...
            private DefaultContextLayer FindChildLayer(DefaultContextLayer layer) {
                DefaultContextLayer startLayer = _currentLayer;
                while (startLayer != null && startLayer.ParentLayer != layer)
                {
            ...
            private void OnLayerRemoved(DefaultContextLayer layer) {
                if (_currentLayer == layer) {
                    ...
                    DefaultContextLayer childLayer = FindChildLayer(layer);
                    if (childLayer != null)
                    {
            ...
            public override void Subscribe(Type contextItemType, SubscribeContextCallback callback) {
                if (contextItemType == null) throw new ArgumentNullException("contextItemType");
                ...
                if (_subscriptions == null) _subscriptions = new Dictionary<Type, SubscribeContextCallback>();
            ...
            private class DefaultContextLayer : ContextLayer {
                private DefaultContextItemCollection _collection;
                ...
                internal Dictionary<Type, ContextItem> Items {
                    get {
                        if (_items == null) _items = new Dictionary<Type, ContextItem>();
                        return _items;
                    }
                }
                ...
                public override void Remove(bool disposing = false) {
                    ...
                    if (_parentLayer != null || disposing) {
                        foreach (ContextItem item in _items.Values)
                        {
        ...
        private sealed class DefaultServiceCollection : ServiceCollection, IDisposable {
            ...
            internal DefaultServiceCollection() {
            }
            ...
            public override void Subscribe(Type serviceType, SubscribeServiceCallback callback) {
                ...
                if (service != null) {
                    ...
                    if (_subscriptions == null) _subscriptions = new Dictionary<Type, SubscribeServiceCallback>();
            ...
            public override void Publish(Type serviceType, object serviceInstance) {
                ...
                if (_services == null) _services = new Dictionary<Type, object>();
