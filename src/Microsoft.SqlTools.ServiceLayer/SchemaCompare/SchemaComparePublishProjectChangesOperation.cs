...
namespace Microsoft.SqlTools.ServiceLayer.SchemaCompare
{
    ...
    /// Class to represent an in-progress schema compare publish project changes operation
    /// </summary>
    class SchemaComparePublishProjectChangesOperation
    {
        ...
        public SchemaComparePublishProjectResult PublishChangesToProject()
        {
            try
            {
                return ComparisonResult.PublishChangesToProject(Parameters.TargetProjectPath, Parameters.TargetFolderStructure);
