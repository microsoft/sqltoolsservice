...
namespace Microsoft.SqlTools.ServiceLayer.ObjectExplorer.KustoModel
{
    ...
    internal partial class ColumnsChildFactory : KustoChildFactoryBase
    {
        ...
        {
            return KustoColumnCustomNodeHelper.CalculateCustomLabel(smoObject, smoContext);
        }
    ...
    static class KustoColumnCustomNodeHelper
    {
        ...
        internal static string CalculateCustomLabel(object context, KustoQueryContext smoContext)
        {
