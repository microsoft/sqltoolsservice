...
{
    /// <summary>
    /// A <see cref="KustoQuerier"/> handles SMO queries for one or more SMO object types.
    /// The <see cref="SupportedObjectTypes"/> property defines which types can be queried.
    /// 
    /// To query multiple 
    /// </summary>
    public abstract class KustoQuerier : IComposableService
    {
        public abstract Type[] SupportedObjectTypes { get;  }
        private static object lockObject = new object();
        
        /// <summary>
        /// Queries SMO for a collection of objects using the <see cref="KustoQueryContext"/> 
        /// </summary>
        /// <param name="context"></param>
        /// <returns></returns>
        public abstract IEnumerable<SqlKustoObject> Query(KustoQueryContext context, string filter, bool refresh, IEnumerable<string> extraProperties);
        ...
        /// </summary>
        protected virtual bool PassesFinalFilters(SqlKustoObject parent, SqlKustoObject smoObject)
        {
            return true;
        }
