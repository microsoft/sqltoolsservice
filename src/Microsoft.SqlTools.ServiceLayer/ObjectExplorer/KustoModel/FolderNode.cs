...
namespace Microsoft.SqlTools.ServiceLayer.ObjectExplorer.KustoModel
{
    ...
    /// </summary>
    public class FolderNode : KustoTreeNode
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns><see cref="NamedKustoObject"/> from this parent's parent, or null if not found</returns>
        public override NamedKustoObject GetParentKustoObject()
        {
