    ...
    internal partial class DatabaseChildFactory : SmoChildFactoryBase
    {
        ...
        protected override void OnExpandPopulateFolders(IList<TreeNode> currentChildren, TreeNode parent)
        {
            ...
            currentChildren.Add(new FolderNode {
                ...
                IsSystemObject = false,
                ValidFor = ValidForFlag.Sql2005|ValidForFlag.Sql2008|ValidForFlag.Sql2012|ValidForFlag.Sql2014|ValidForFlag.Sql2016|ValidForFlag.Sql2017|ValidForFlag.Sql2019|ValidForFlag.Sql2022OrHigher|ValidForFlag.AzureV12,
                SortPriority = SmoTreeNode.NextSortPriority,
            });
            currentChildren.Add(new FolderNode {
            ...
            currentChildren.Add(new FolderNode {
                ...
                IsSystemObject = false,
                ValidFor = ValidForFlag.Sql2016|ValidForFlag.Sql2017|ValidForFlag.Sql2019|ValidForFlag.Sql2022OrHigher|ValidForFlag.AzureV12|ValidForFlag.SqlOnDemand,
                SortPriority = SmoTreeNode.NextSortPriority,
            });
            currentChildren.Add(new FolderNode {
    ...
    internal partial class TablesChildFactory : SmoChildFactoryBase
    {
        ...
        public override IEnumerable<NodeSmoProperty> SmoProperties
        {
            get
            {
                ...
                {
                   Name = "IsFileTable",
                   ValidFor = ValidForFlag.Sql2012|ValidForFlag.Sql2014|ValidForFlag.Sql2016|ValidForFlag.Sql2017|ValidForFlag.Sql2019|ValidForFlag.Sql2022OrHigher
                });
                properties.Add(new NodeSmoProperty
                {
                ...
                {
                   Name = "IsEdge",
                   ValidFor = ValidForFlag.Sql2017|ValidForFlag.Sql2019|ValidForFlag.Sql2022OrHigher|ValidForFlag.AzureV12
                });
                properties.Add(new NodeSmoProperty
                {
                   Name = "IsNode",
    ...
    internal partial class ProgrammabilityChildFactory : SmoChildFactoryBase
    {
        ...
        protected override void OnExpandPopulateFolders(IList<TreeNode> currentChildren, TreeNode parent)
        {
            ...
            currentChildren.Add(new FolderNode {
                ...
                IsSystemObject = false,
                ValidFor = ValidForFlag.Sql2012|ValidForFlag.Sql2014|ValidForFlag.Sql2016|ValidForFlag.Sql2017|ValidForFlag.Sql2019|ValidForFlag.Sql2022OrHigher|ValidForFlag.AzureV12,
                SortPriority = SmoTreeNode.NextSortPriority,
            });
        }
    ...
    internal partial class ExternalResourcesChildFactory : SmoChildFactoryBase
    {
        ...
        protected override void OnExpandPopulateFolders(IList<TreeNode> currentChildren, TreeNode parent)
        {
            ...
            currentChildren.Add(new FolderNode {
                ...
                IsSystemObject = false,
                ValidFor = ValidForFlag.Sql2016|ValidForFlag.Sql2017|ValidForFlag.Sql2019|ValidForFlag.Sql2022OrHigher|ValidForFlag.SqlOnDemand,
                SortPriority = SmoTreeNode.NextSortPriority,
            });
        }
    ...
    internal partial class ServiceBrokerChildFactory : SmoChildFactoryBase
    {
        ...
        protected override void OnExpandPopulateFolders(IList<TreeNode> currentChildren, TreeNode parent)
        {
            ...
            currentChildren.Add(new FolderNode {
                ...
                IsSystemObject = false,
                ValidFor = ValidForFlag.Sql2008|ValidForFlag.Sql2012|ValidForFlag.Sql2014|ValidForFlag.Sql2016|ValidForFlag.Sql2017|ValidForFlag.Sql2019|ValidForFlag.Sql2022OrHigher,
                SortPriority = SmoTreeNode.NextSortPriority,
            });
        }
    ...
    internal partial class StorageChildFactory : SmoChildFactoryBase
    {
        ...
        protected override void OnExpandPopulateFolders(IList<TreeNode> currentChildren, TreeNode parent)
        {
            ...
            currentChildren.Add(new FolderNode {
                ...
                IsSystemObject = false,
                ValidFor = ValidForFlag.Sql2008|ValidForFlag.Sql2012|ValidForFlag.Sql2014|ValidForFlag.Sql2016|ValidForFlag.Sql2017|ValidForFlag.Sql2019|ValidForFlag.Sql2022OrHigher|ValidForFlag.AzureV12,
                SortPriority = SmoTreeNode.NextSortPriority,
            });
            currentChildren.Add(new FolderNode {
