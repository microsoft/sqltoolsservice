...
namespace Microsoft.SqlTools.ServiceLayer.Agent
{
    ...
    /// </summary>
    internal sealed class JobStepAdvancedLogging : System.Windows.Forms.UserControl, IJobStepPropertiesControl
    {
        ...
        public JobStepAdvancedLogging(CDataContainer dataContainer, IMessageBoxProvider messageProvider, JobStepData jobStepData)
        {
            // This call is required by the Windows.Forms Form Designer.
            InitializeComponent();
...
#region internal helpers
        ...
        private string ReadLogToFile(string fileName)
        {
            ...
            if (data.Tables.Count > 0)
            {
                ...
                STrace.Assert(table.Columns.Count == 2, "Unexpected number of columns returned");
