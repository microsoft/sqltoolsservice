...
namespace Microsoft.SqlTools.ServiceLayer.Agent
{
    ...
    /// </summary>
    internal class JobSteps : SqlManagementUserControl, IPanelForm, ISupportValidation
    {
        ...
        public JobSteps(CDataContainer dataContainer, JobData data)
        {
            ...
            this.HelpF1Keyword = AssemblyVersionInfo.VersionHelpKeywordPrefix + @".ag.job.steps.f1";
