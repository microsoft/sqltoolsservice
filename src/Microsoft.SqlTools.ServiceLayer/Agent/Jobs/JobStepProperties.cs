...
namespace Microsoft.SqlTools.ServiceLayer.Agent
{
    ...
    /// </summary>
    internal class JobStepProperties : SqlManagementUserControl, IPanelForm
    {
        /// <summary>
        ...
        private System.Windows.Forms.ComboBox runAs;
        private JobStepSubSystems subSystems;
        private JobPropertiesAdvanced advanced = null;
        private Microsoft.SqlServer.Management.SqlManagerUI.JobStepDefinition jobStepDefinition = null;
        ...
        internal JobStepProperties(CDataContainer dataContainer, JobStepData context, JobPropertiesAdvanced advancedPanel, IServiceProvider service)
        {
            ...
            this.HelpF1Keyword = AssemblyVersionInfo.VersionHelpKeywordPrefix + @".ag.job.stepgeneral.f1";
        ...
        private JobStepSubSystems SubSystems
        {
            get
            {
                ...
                {
                    this.subSystems = new JobStepSubSystems(this.DataContainer, this.data, this.MessageBoxProvider, this.serviceProvider);
                }
