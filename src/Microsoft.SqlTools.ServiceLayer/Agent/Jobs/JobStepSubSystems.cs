...
namespace Microsoft.SqlTools.ServiceLayer.Agent
{
    ...
    internal class JobStepSubSystems
    {
        ...
        private static JobStepSubSystem CreateJobStepSubSystemSsis(AgentSubSystem agentSubSystem, CDataContainer dataContainer, JobStepData data,
            IMessageBoxProvider messageProvider)
        {
    ...
    internal class JobStepSubSystem
    {
        ...
        public Control Advanced
        {
            get
            {
                return this.stepSpecificAdvanced;
            }
        }
        #endregion
    }
