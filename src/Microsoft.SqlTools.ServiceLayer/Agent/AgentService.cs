...
namespace Microsoft.SqlTools.ServiceLayer.Agent
{
    ...
    public sealed class AgentService
    {
        ...
        private void TestApi(ServerConnection serverConnection)
        {
            ...
            {
                string jobName = Convert.ToString(dt.Rows[i]["JobName"], System.Globalization.CultureInfo.InvariantCulture);
                int jobCategoryId = Convert.ToInt32(dt.Rows[i]["RunStatus"], System.Globalization.CultureInfo.InvariantCulture);
                Guid jobId = (Guid) (dt.Rows[i]["JobId"]);
