...
namespace Microsoft.SqlTools.Sts2.Contracts
{
    ...
    public static class Sts2Methods
    {
        ...
        [
            ...
            new() { Name = "v2/diagnostics.setCapture", Kind = "request", Summary = "Change capture mode at runtime; journaled config change.", Milestone = "M3" },
            new() { Name = "v2/toy.echo", Kind = "request", Summary = "M1 spine probe: echoes text and counts calls. Removed before preview.", Milestone = "M1", Toy = true },
            new() { Name = "v2/toy.effect", Kind = "request", Summary = "M1 spine probe: round-trips through the effect runner. Removed before preview.", Milestone = "M1", Toy = true },
